...
\noindent For this experiment, the data was generated in the same manner as experiment 1, using the following parameters in Eq. 9: 
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../output/training_3_a_roc.jpg}
        \caption{Training 3}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../output/training_6_a_roc.jpg}
        \caption{Training 6}
    \end{subfigure}
    \caption{ROC Curves --- Result A}
    \label{fig:roc-a}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../output/training_3_b_roc.jpg}
        \caption{Training 3}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../output/training_6_b_roc.jpg}
        \caption{Training 6}
    \end{subfigure}
    \caption{ROC Curves --- Result B}
    \label{fig:roc-b}
\end{figure}
